package starling.extend
{
	 ...
	 */
	public class AdvanceTextField extends DisplayObjectContainer
	{
		...
		public function AdvanceTextField(width:int, height:int, text:String, fontNameV:String="Verdana",
		...
		private function createRenderedContents():void
		{
			...
			{
				//设置文字为空,这里不要去重新生成bitmapdata，而直接用空纹理处理
				if(!mImage)
				{
					return;
					//					mImage = new Image(texture);
		...
		private function renderText(scale:Number, resultTextBounds:Rectangle):BitmapData
		{
			...
			if(!textFormat)
			{
				textFormat = new TextFormat(mFontName, mFontSize * scale, mColor, mBold, mItalic, mUnderline, null, null, hAlign);
		...
		{
			return sNativeTextField.defaultTextFormat;
		}
		
		public function set format(value:TextFormat):void
		{
			sNativeTextField.defaultTextFormat = value;
			mRequiresRedraw = true;
		}
		
		public function get multiline():Boolean
		{
			return sNativeTextField.multiline;
		}
		public function set multiline(value:Boolean):void
		{
			sNativeTextField.multiline = value;
			mRequiresRedraw = true;
		}
		
		public function set wordWrap(value:Boolean):void
		{
			sNativeTextField.wordWrap = value;
			mRequiresRedraw = true;
		}
		public function get wordWrap():Boolean
		{
			return sNativeTextField.wordWrap;
		}
		
		public function get textImage():DisplayObject
		{
			return this.mQuadBatch;
		}
