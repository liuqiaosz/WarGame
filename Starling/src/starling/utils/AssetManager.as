package starling.utils
{
    ...
    public class AssetManager extends EventDispatcher
    {
		...
		protected var mIsLoading:Boolean;//modify by liquiao on 2014-05-12
                                        ...
                                        options:TextureOptions=null):String
        {
			 ...
			 * 这里跳过已经加载的同类型资源
			 */
			var extension:String = asset.split(".").pop().toLowerCase().split("?")[0];
			switch(extension)
			{
				case "json":
                ...
                for each (var xml:XML in xmls)
                {
                    ...
                    else if (rootNode == "font")
                    {
                        ...
                        if (texture)
                        {
							...
							AdvanceTextField.registerBitmapFont(new BitmapFont(texture, xml), name);
